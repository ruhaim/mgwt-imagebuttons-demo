...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "mgwt_2_0_image_buttons" because\n';
  ...
  $wnd.__gwt_activeModules['mgwt_2_0_image_buttons'] = {
    'moduleName' : 'mgwt_2_0_image_buttons',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/mgwt_2_0_image_buttons.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['mgwt_2_0_image_buttons'].superdevmode = true;

  var expectedSuffix = '/mgwt_2_0_image_buttons.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + mgwt_2_0_image_buttons + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:mgwt_2_0_image_buttons';
  var devModeSessionKey = '__gwtDevModeSession:mgwt_2_0_image_buttons';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/mgwt_2_0_image_buttons/mgwt_2_0_image_buttons.nocache.js';
  ...
  $wnd.__gwt_activeModules['mgwt_2_0_image_buttons'].canRedirect = true;
  $wnd.__gwt_activeModules['mgwt_2_0_image_buttons'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING mgwt_2_0_image_buttons';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/mgwt_2_0_image_buttons?user.agent=' + ua + '&_callback=' + callback;
